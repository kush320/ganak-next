...
// export default function Suchi({ params }) {
// 	const [value, setValue] = React.useState(1);
// 	const [data, setData] = React.useState(1);
// 	const [clinic, setClinic] = React.useState(1);

// 	const [suchi, setSuchi] = React.useState({
// 		suchiId: "7cea7663-fdeb-4557-92da-6d4c1cdd9c16",
// 		ward: 5,
// 		bastiName: "Tole hamro",
// 		question1_1: "Lamsal Abiral",
// 		question1_2: "male",
// 		question2_1: "Hindu",
// 		question2_2: "Bahun",
// 		question3_1: [4, 1],
...
// 		question31_1: 1,
// 		question31_2: "This is a reason",
// 		question31_3: 1,
// 		question31_4: "This is a reason",
...
// 	});
// 	React.useEffect(() => {
// 		getRequest(`/api/suchi/get-suchi?suchiId=${params.id}`).then((data) => {
// 			setSuchi(data.data);
// 		});
// 	}, []);
...
// 						१. परिवार मूलीको नाम
// 					</Text>
// 					<Input value={suchi.question1_1} variant="outline" width={"40%"} />
// 				</HStack>
// 				<Text marginLeft={"5%"} marginTop={"2%"} fontWeight={"bold"}>
// 					लिङ्ग
// 				</Text>
// 				<RadioGroup value={suchi.question1_2} marginBottom={"5%"}>
// 					<Stack marginLeft={"5%"} marginTop={"1%"} direction="column">
// 						<Radio value={"female"}>महिला</Radio>
// 						<Radio value={"male"}>पुरुष</Radio>
// 						<Radio value={"others"}>तेस्रो लिङ्गी</Radio>
// 					</Stack>
// 				</RadioGroup>
// 			</Box>
// 			<Box
...
// 							<Td>
// 								<Input
// 									value={suchi.question3_1.length}
// 									variant="outline"
// 									width={"60%"}
// 								/>
// 							</Td>
// 							<Td>
// 								<Input
// 									value={suchi.question3_2.length}
// 									variant="outline"
// 									width={"60%"}
// 								/>
// 							</Td>
// 							<Td>
// 								<Input
// 									value={suchi.question3_1.length + suchi.question3_2.length}
// 									variant="outline"
// 									width={"60%"}
// 								/>
// 							</Td>
...
// 				<RadioGroup value={suchi.question4} marginBottom={"5%"}>
// 					<Stack marginLeft={"5%"} marginTop={"1%"} direction="column">
...
// 				</Text>
// 				<Text marginLeft={"5%"}> स्वास्थ्य चौकी पुग्न लाग्ने समय</Text>
// 				<RadioGroup value={suchi.question5_1} marginBottom={"5%"}>
// 					<Stack marginLeft={"5%"} marginTop={"1%"} direction="column">
// 						<Radio value={1}>१५ मिनेट</Radio>
// 						<Radio value={2}>३० मिनेट</Radio>
// 						<Radio value={3}>१ घण्टा</Radio>
// 						<Radio value={4}>१ घण्टाभन्दा बढी</Radio>
// 					</Stack>
// 				</RadioGroup>
// 				<Text marginLeft={"5%"}>अस्पताल पुग्न लाग्ने समय</Text>
// 				<RadioGroup value={suchi.question5_2} marginBottom={"5%"}>
// 					<Stack
// 						marginLeft={"alue={suchi.question5_1}%"}
// 						marginTop={"1%"}
// 						direction="column"
// 					>
// 						<Radio value={1}>१५ मिनेट</Radio>
